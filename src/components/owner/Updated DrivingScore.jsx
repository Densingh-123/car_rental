...
import { Award, TrendingUp, AlertTriangle, Zap, Shield } from 'lucide-react';
...
const DrivingScore = ({ score = 85 }) => {
  ...
  const scoreBreakdown = [
    { category: 'Safety', score: 92, color: 'green' },
    { category: 'Efficiency', score: 85, color: 'blue' },
    { category: 'Smoothness', score: 88, color: 'purple' },
    { category: 'Compliance', score: 82, color: 'orange' }
  ];
    ...
    >
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <p className="text-blue-900/70">Your driver's performance rating</p>
        </div>
        ...
        {scoreBreakdown.map((item, index) => (
          <div key={item.category}>
            <div className="flex justify-between items-center mb-1">
              <span className="text-sm font-semibold text-blue-900/70">{item.category}</span>
